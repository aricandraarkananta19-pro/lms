...
<head>
    ...
    <meta name="description" content="T-LMS Enterprise - Corporate Learning & Compliance Platform by Talenta Traincom Indonesia">
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .user-card:hover { background: var(--primary-lighter); }
        ...
        .main-content .bg-gray-100 { background: transparent !important; }
        .main-content .min-h-screen { min-height: auto !important; }
        ...
        .main-content .rounded-2xl { border-radius: var(--radius-lg) !important; }
        .main-content .shadow-sm { box-shadow: var(--shadow-sm) !important; }
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('learning-paths.index') }}" class="nav-item {{ request()->routeIs('learning-paths.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>
                Learning Path
            </a>
            <a href="{{ route('tasks.index') }}" class="nav-item {{ request()->routeIs('tasks.*') || request()->routeIs('courses.tasks.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
                Tugas
            </a>
            <a href="{{ route('quizzes.index') }}" class="nav-item {{ request()->routeIs('quizzes.*') || request()->routeIs('courses.quizzes.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Kuis
            </a>
            <a href="{{ route('webinars.index') }}" class="nav-item {{ request()->routeIs('webinars.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                Live Webinar
            </a>
            ...
            <a href="{{ route('certifications.index') }}" class="nav-item {{ request()->routeIs('certifications.*') ? 'active' : '' }}">
